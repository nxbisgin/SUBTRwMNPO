function [indxbests_mMCG,AmMCG]=SelectSens_mMCG_Based_mRMR(data,sf,channel_labels,ixExclusionSensors,nFeatures)
...
% @Descalona 2014
    ...
    [selectedFeatures_mMCG,classMI_mMCG,TotalScore_mMCG,I_cxj_mMCG,Sum_xi_xj_mMCG,Sum_xi_xjFeatures_mMCG,TotalScoreFeatures_mMCG]= mRMR_D(nFeatures,data_bndf(1:block,ix),TemplateData_mMCG);
    ...
    AmMCG.TotalScore=TotalScore_mMCG;
    AmMCG.I_cxj=I_cxj_mMCG;
    AmMCG.Sum_xi_xj=Sum_xi_xj_mMCG;
    AmMCG.Sum_xi_xjFeatures=Sum_xi_xjFeatures_mMCG;
