function [indxbests_fMCG,AfMCG]=SelectSens_fMCG_Based_MaxRelfeaturesfromExclusionArea(data,sf,channel_labels,ixExclusionSensors,indxbests_mMCG,nFeaturesUser)
...
% defauld nFeatures to chose
    ...
    ix=find(ix);    
    % selected features based on mRMR for fMCG  [selectedFeatures,classMI,TotalScoreFeatures] 
    [selectedFeatures_fMCG,classMI_fMCG,TotalScoreFeatures_fMCG]= MaxRel(nFeatures,data_bndf(1:block,ix),TemplateData_fMCG);
    ...
    AfMCG.ixdefauld_fMCG=ixdefauld_fMCG;
